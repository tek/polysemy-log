...
;
    polysemy-log = {
  meta = {
    sha256 = "1dpgcvrjgpdpynnx804sdj4kpf06lvq0bqxqc79lazc2q82vaj6s";
    url = "https://hackage.haskell.org";
    ver = "0.7.2.0";
  };
  drv = { mkDerivation, ansi-terminal, async, base, incipit-core, lib
...
mkDerivation {
  pname = "polysemy-log";
  version = "0.7.2.0";
  src = /nix/store/n2v3zkwvdm70ww7s1wndpai1xms3g5h5-source;
  libraryHaskellDepends = [
    ansi-terminal async base incipit-core polysemy polysemy-conc
    polysemy-time stm time
  ];
...
;
    zigzag = {
  meta = {
    sha256 = "0m726bg0rnq83lq42676yz2l3id14ilc6zml9zqwijs9i7f4cmas";
    url = "https://hackage.haskell.org";
    ver = "0.1.0.0";
  };
  drv = { mkDerivation, base, lib, tasty, tasty-hunit, tasty-quickcheck }:
mkDerivation {
  pname = "zigzag";
  version = "0.1.0.0";
  src = /nix/store/sx07bdvbkyjg2pshyljly5y5yas783f0-source;
  libraryHaskellDepends = [ base ];
