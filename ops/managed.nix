{
  ...
  overrides = {
    ...
    lower-polysemy-log = {
      ...
      prettyprinter-ansi-terminal = {
        version = "1.1.4";
        hash = "0kyl47b83rs2kbifam2wimqv1zz80qkfwznkmq5qwlhr05gxrz58";
        repo = "hackage.haskell.org";
      };
      primitive = {
        version = "0.8.0.0";
    ...
    lower-polysemy-log-co = {
      ...
      constraints-extras = {
        version = "0.4.0.2";
        hash = "150a742f67sjmaac4g40hzvkdnmnhsf2g49zn3jsh4p2brf9hvp5";
        repo = "hackage.haskell.org";
      };
      contiguous = {
        version = "0.6.4.2";
      ...
      dependent-map = {
        version = "0.4.0.1";
        hash = "0p1sh5a7r69insg6v48pc51j7zs4imfh3mvhxa09jry8xg9a1lwn";
        repo = "hackage.haskell.org";
      };
      dependent-sum = {
        version = "0.7.2.0";
        hash = "1m85k11y97y7v6705bb6f9kpg6bcbm521p1p1812v0ybzkr2mg80";
        repo = "hackage.haskell.org";
      };
      happy = {
        version = "2.2";
      ...
      polysemy-log = {
        version = "0.7.2.0";
        hash = "1dpgcvrjgpdpynnx804sdj4kpf06lvq0bqxqc79lazc2q82vaj6s";
        repo = "hackage.haskell.org";
      };
      polysemy-resume = {
        version = "0.5.0.0";
      ...
      zigzag = {
        version = "0.1.0.0";
        hash = "0m726bg0rnq83lq42676yz2l3id14ilc6zml9zqwijs9i7f4cmas";
        repo = "hackage.haskell.org";
      };
    };
    lower-polysemy-log-di = {
